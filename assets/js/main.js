...
/* ---- "My role & experience" expand/collapse on each project ----
   Markup expected:
   <button class="project-toggle" aria-expanded="false" data-toggle>...</button>
   <div class="project-more" hidden>...</div>
   The button toggles the hidden attribute on the very next element.
*/
